                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th ><?=$this->lang->line('question_level_title')?></th>
                        ...
                        <tbody>
                            <?php if(inicompute($question_levels)) {$i = 1; foreach($question_levels as $question_level) { ?>
                                <tr>
                                    <td data-title="<?=$this->lang->line('slno')?>" style="width: 40px;text-align: center;">
                                        <?php echo $i; ?>
                                    </td>
