            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                            $array = array('' => $this->lang->line("question_bank_class"));
                            $classlist=$this->db->query("select * from section")->result();
                            foreach ($classlist as $classlist) {
                                $array[$classlist->sectionID] = $classlist->section;
                            }
                            echo form_dropdown("class", $array, set_value("class", $question_bank->class_stream), "id='class' class='form-control select2'");
                            ?>
                        </div>
                    ...
                    ?>
                        <label for="type" class="col-sm-2 control-label">
                            Answer Type <span class='text-red'>*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                            $array = array(0 => $this->lang->line("question_bank_select"));
                    ...
                    if(form_error('hints'))
                        ...
                        echo "<div class='form-group' id='hintsDiv' >";
                    ?>
                    ...
                    if(form_error('explanation'))
                        ...
                        echo "<div class='form-group' id='explanationDiv' >";
                    ?>
