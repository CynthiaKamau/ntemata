                                    ...
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
                                                ...
                                                <th ><?=$this->lang->line('student_registerNO')?></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="<?=$this->lang->line('student_registerNO')?>">
                                                      ...
                                                      <td data-title="<?=$this->lang->line('student_classes')?>">
                                                        <?php $acdemacy= $student->classesID;
                                                        $getaccedmany=$this->db->query("select * from classes where classesID='$acdemacy'")->result_array();
                                                        echo $getaccedmany[0]['classes'];
                                                        
                                                        ?>
                                                    </td>
                                                      <td data-title="<?=$this->lang->line('student_section')?>">
                                                        <?php  $sectionID=$student->sectionID;
                                                        
                                                          $getclass=$this->db->query("select * from section where sectionID='$sectionID'")->result_array();
                                    ...
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
                                                ...
                                                <th ><?=$this->lang->line('student_name')?></th>
                                                <th ><?=$this->lang->line('student_roll')?></th>
                                                <th c><?=$this->lang->line('student_email')?></th>
                                                <?php if(permissionChecker('student_edit') || permissionChecker('student_delete') || permissionChecker('student_view')) { ?>
                                                <th ><?=$this->lang->line('action')?></th>
                                                <?php } ?>
                                            </tr>
