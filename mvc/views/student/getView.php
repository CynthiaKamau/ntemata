                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        /*<li><a href="#exam" data-toggle="tab"><?=$this->lang->line('student_exam')?></a></li>*/
                            ...
                            $groupIds = $query->result();
                            foreach ($groupIds as $val) {
                        ?>
                            <li><a href="#exam-<?php echo $val->title; ?>" data-toggle="tab"><?php echo $val->title?></a></li>
                        <?php
                            }
                        ?>
                    ...
                    <div class="tab-content">
                        ...
                        <?php } ?>
                            <?php 
                                foreach($groupIds as $val){
                                    $examQuesresults = pluck($this->online_exam_m->get_order_by_online_exam_specific_group(array('published'=>1),$val->questionGroupID),'obj','onlineExamID');                                
                            ?>
                                <div class="tab-pane" id="exam-<?php echo $val->title; ?>">
                                    <div id="hide-table">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php if(inicompute($examQuesresults)) { $i = 1; foreach ($examresults as $examresult) {  ?>
                                                    <tr>
