        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div style="display: none;" class="form-group <?=form_error('state') ? 'has-error' : ''?>">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("sectionID", $array, set_value("sectionID"), "id='sectionID' class='form-control select2' onchange='get_capacity()'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <!--<div style="display: " class="form-group <?=form_error('sectionID') ? 'has-error' : ''?>">
                        <label style="display: none;" for="sectionID" class="col-sm-2 control-label">
...
-->
                    ...
                    <div style="display: none" class="form-group <?=form_error('roll') ? 'has-error' : ''?>">
                        <label for="roll" class="col-sm-2 control-label">
                            <?=$this->lang->line("student_roll")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="hidden" class="form-control" id="roll" name="roll" value="<?php  echo  (rand(111111111,999999999)); ?>" >
                        </div>
                        <span class="col-sm-4 control-label">
