                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("class_stream")?> </span>: <?php $section_list=$profile->section_list;
                                        $sectionlist=explode(',',$section_list);
                                        foreach($sectionlist as $seclisting)
                                        {
                                            $getsecname=$this->db->query("select * from section where sectionID='$seclisting'")->result_array();
                                            echo $getsecname[0]['section'].',';
                                        }
                                        
                                        ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("subjects_name")?> </span>: 
                                        
                                        <?php $subjects_list=$profile->subjects_list;
                                        $subjectlist=explode(',',$subjects_list);
                                        foreach($subjectlist as $sublisting)
                                        {
                                            $getsubname=$this->db->query("select * from subject where subjectID='$sublisting'")->result_array();
                                            echo $getsubname[0]['subject'].',';
                                        }
                                     ...
                                     <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("subjects_type")?> </span>: <?=$profile->subjects_type?></p>
                                    </div>
                                     <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("subjects_code")?> </span>: <?=$profile->subjects_code?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
