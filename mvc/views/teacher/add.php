            ...
            <div class="col-sm-10">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="designation" placeholder="e.g. Head of STEM activities" name="designation" value="<?=set_value('designation')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" required class="form-control" id="phone" name="phone" value="<?=set_value('phone')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                $array = array();
                                $array[0] = $this->lang->line("select_class_stream");

                                foreach ($class_streams as $class_streams) {
                                    $array[$class_streams->sectionID] = $class_streams->section;
                                }
                        ...
                        <div class="col-sm-6">
                             <?php
                                ...
                                foreach ($subjectlist as $subjectlist) {
                                    $array[$subjectlist->subjectID] = $subjectlist->subject;
                                }
                                echo form_multiselect("subjectID[]", $array, set_value("subjectID"), "id='subjectID' class='form-control select2'");
                            ?>
                        </div>
                         <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="subjects_type" name="subjects_type" value="<?=set_value('subjects_type')?>" >
                        </div>
                         <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="subjects_code" name="subjects_code" value="<?=set_value('subjects_code')?>" >
                        </div>
                         <span class="col-sm-4 control-label">
