...
-->
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <select class="form-control select2" name="teacherID[]" id="teacherID" multiple>
                                <option value=""></option>
                                <?php
                                $teacherlist=$section->teacherID;
                                 $sectionlist=explode(',',$teacherlist);
                                   foreach ($teachers as $teacher) {
                                       $teacherID=$teacher->teacherID;
                                ?>
                                <option <?php if (in_array($teacherID, $sectionlist)) { ?> selected <?php } else {  ?> <?php } ?> value="<?php echo $teacher->teacherID; ?>"><?php echo $teacher->name; ?></option>
                                <?php
                                   }
                                   ?>
                            </select>
