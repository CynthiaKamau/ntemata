                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                <th class="col-lg-1"><?=$this->lang->line('slno')?></th>
                                 <th class="col-lg-1">Academic Level</th>
                        ...
                        <tbody>
                            ...
                            <?php   if(inicompute($sections)) {$i = 1; foreach($sections as $section) { ?>
                                <tr>
                                    <td data-title="<?=$this->lang->line('slno')?>">
                                        <?php echo $i; ?>
                                    </td>
                                     <td >
                                        <?php  $classesID= $section->classesID;  
                                        $getacedamicdetails=$this->db->query("select * from classes where classesID='$classesID'")->result_array();
                                        echo $getacedamicdetails[0]['classes'];
                                    ...
                                    <td data-title="<?=$this->lang->line('section_teacher_name')?>">
                                        ...
                                        $getteachername=$this->db->query("select * from teacher where teacherID in($teacherID)")->result_array();
                                      
                                        foreach($getteachername as $teacherlist)
                                        {
                                           echo $teacherlist['name'].','; 
                                        }
                                        ?>
                                    </td>
