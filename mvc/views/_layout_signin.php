...
<head>
    ...
    <title>Sign in</title>
    <link rel="icon" type="image/png"  href="<?=base_url("assets/feviicon/")?>favicon-96x96.png" sizes="96x96" />
    <!-- bootstrap 3.0.2 -->
    ...
    <div class="col-md-4 col-md-offset-4 marg" style="margin-top:30px;">
        <?php
            if(inicompute($siteinfos->photo)) {
                echo "<center><a href='https://www.ntemata.io/' target='_blank'><img width='398' height='111' src=".base_url('uploads/images/'.$siteinfos->photo)." /></a></center>";
            }
        ?>
