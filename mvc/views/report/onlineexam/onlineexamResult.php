                   ...
                   <div class="box box-solid " style="border: 1px #ccc solid; border-left: 2px black solid">
                        ...
                        <?php if(inicompute($user)) { ?>
                            ...
                            <table class="table table-bordered ">
                                <tbody>
                                    <tr>
                                        <td ><span class='text-blue'><?=$this->lang->line('onlineexamreport_exam')?>  Taken: <?=$onlineexam->name?> </span></td>
                                ...
                                <form action="<?php echo base_url(); ?>onlineexamreport/add_remarks" method="post">
                                <div class="col-md-6">
                                    <label>Remarks</label>
                                    <input type="hidden" name="resultid" id="resultid" value="<?php echo $onlineExamUserStatusID; ?>">
                                    <textarea class="form-control" name="remarks" id="remarks"><?=$onlineExamUserStatus->remarks?></textarea>
                                </div>
                                 <div class="col-md-6">
                                    <label>Authorize </label>
                                    <?php $authorized=$onlineExamUserStatus->remarks; ?>
                                    <select class="form-control" name="authorized" id="authorized">
                                        <option <?php if($authorized='No') { ?>  selected <?php } ?> value="No">No</option> 
                                      <option <?php if($authorized='Yes') { ?>  selected <?php } ?> value="Yes">Yes</option>  
