                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th ><?=$this->lang->line('parents_photo')?></th>
                                <th ><?=$this->lang->line('parents_name')?></th>
                                <th ><?=$this->lang->line('parents_email')?></th>
                                <?php if(permissionChecker('parents_edit')) { ?>
                                <th ><?=$this->lang->line('parents_status')?></th>
                                <?php } ?>
                        ...
                        <tbody>
                            <?php if(inicompute($parents)) {$i = 1; foreach($parents as $parent) { ?>
                                <tr>
