                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("section", $array, set_value("section"), "id='section' class='form-control select2' onchange='get_capacity()'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("subject", $array, set_value("subject"), "id='subject' class='form-control select2' onchange='get_teacher()'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
