                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("section", $array, set_value("section", $online_exam->sectionID), "id='section' class='form-control select2'  onchange='get_capacity()'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="capacity" class="col-sm-2 control-label">
                            <?=$this->lang->line("online_exam_capacity")?>
                          
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="capacity" name="capacity" value="<?=set_value('name', $online_exam->num_lerner)?>">
                        </div>
                        <span class="col-sm-4 control-label">
...
--->
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("subject", $array, set_value("subject", $online_exam->subjectID), "id='subject' class='form-control select2' onchange='get_teacher()'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="teacher" class="col-sm-2 control-label">
                            <?=$this->lang->line("online_exam_teacher")?>
                        </label>
                        <div class="col-sm-6">
                            <select class="form-control select2" name="teacher" id="teacher">
                                   
                                <?php
                                $teacher=$online_exam->teacher;
                                $getteacherdetails=$this->db->query("select * from teacher where teacherID='$teacher'")->result_array();
                                foreach($getteacherdetails as $teacherlist)
                                {
                                ?>
                                <option value="<?php echo $teacherlist['teacherID']; ?>"><?php echo $teacherlist['name']; ?></option>
                                <?php
                                }
                                ?>
                            </select>
    ...
    function get_capacity()
{
   var section=$("#section").val();
     $.ajax({
                    type: 'POST',
                    url: "<?=base_url('online_exam/getlerner')?>",
    ...
    function get_teacher()
{
   ...
   $.ajax({
                    type: 'POST',
                    url: "<?=base_url('online_exam/getteacher')?>",
