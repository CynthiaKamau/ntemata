    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover table-responsive dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-2"><?=$this->lang->line('classes_subjects')?></th>
                        ...
                        <tbody>
                            <?php if(inicompute($classes)) {$i = 1; foreach($classes as $class) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('classes_subjectss') ?>">
                                         <?php
                                         if ($class->classes === "Upper Primary"){
                                             echo $class->upperSubjects;
                                         } else if ($class->classes === "Lower Primary") {
                                             echo $class->lowerSubjects;
                                         } else {
                                             echo "Not applicable";
                                         }
                                   ?>
