	...
	protected function rules() {
		$rules = array(
			...
			array(
				...
				'rules' => 'trim|required|alpha_numeric|max_length[11]|xss_clean|callback_unique_classes_numeric|callback_valid_number'
			), 
			array(
				'field' => 'teacherID', 
		...
		if($_POST) {
			...
			if ($this->form_validation->run() == FALSE) { 
				...
				$array = array(
					...
					"upperSubjects" => $this->input->post("upperSubjects"),
					"lowerSubjects" => $this->input->post("lowerSubjects"),
