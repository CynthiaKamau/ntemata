...
*/
	...
	{
	    $examresult=$this->input->post('resultid');
	     $remarks=$this->input->post('remarks');
	      $authorized=$this->input->post('authorized');
	    $updaterecord=$this->db->query("UPDATE online_exam_user_status set remarks='$remarks',authorized='$authorized' WHERE onlineExamUserStatus='$examresult'");
	    
	    $this->session->set_flashdata('success', 'Remarks Successfully saved.');
		redirect(base_url("onlineexamreport/result/$examresult"));
	}
