    ...
    */
    ...
    protected function rules($type = 2, $ispaid = 0) {
        $rules = array(
            ...
            array(
                'field' => 'capacity',
                'label' => $this->lang->line("online_exam_capacity"),
    ...
    public function getlerner()
    {
         ...
         $gettotallerner=$this->db->query("select * from section where sectionID='$section'")->result_array();
         echo $gettotallerner[0]['capacity'];
    }
     ...
     public function getteacher()
    {
        ...
        $getteacherlist=$this->db->query("SELECT * FROM `teacher` WHERE find_in_set('$subject',subjects_list)")->result();
       foreach ($getteacherlist as $teacherlist)
       {
           echo "<option value=\"$teacherlist->teacherID\">",$teacherlist->name,"</option>";
       }
    }


 public function editgetteacher()
    {
          $subject = $this->input->post('subject'); 
       ...
       foreach ($getteacherlist as $teacherlist)
       {
           echo "<option selected value=\"$teacherlist->teacherID\">",$teacherlist->name,"</option>";
       }
    }
